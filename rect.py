...
def main():
    ...
    colors = {'red': pygame.Color('red'),'blue': pygame.Color('blue'),'green': pygame.Color('green'), 'yellow': pygame.Color('yellow'),'white': pygame.Color('white'),
    ...
    while not done:
        ...
        if x == 0: current_color = colors['blue']
            ...
            current_color = colors['white']
        screen.fill(colors[(0,0,0)])
        pygame.drw.rect(screen,current_color,(x,y,sprite_width,sprite_height))
        pygame.display.flip()
        clock.tick(90)
    pygame.quit()

...
font_size = 72
pygame.init()
backround_image = pygame.transform.scale(pygame.image.load("bg.jpg"), (screen_width, screen_height))
font = pygame.font.SysFont("times new roamn", font_size)
...
while running:
    ...
    if not won:
        ...
        if sprite1.rect.collicderect(sprite2.rect):
